...
const MACDIndicator = require('../indicators/MACDIndicator');
const WilliamsRIndicator = require('../indicators/WilliamsRIndicator');
const AwesomeOscillator = require('../indicators/AwesomeOscillator');
